...
## Цель
Синхронизировать каталог товаров из 1С:Управление небольшой фирмой в локальную базу данных PostgreSQL для быстрого доступа и поиска товаров в системе SmartOrder Engine.
