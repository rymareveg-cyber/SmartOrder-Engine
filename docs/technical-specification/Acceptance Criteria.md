...
### 7.1. Экспорт счетов
- ✅ Экспорт счетов в 1С работает (при статусе "invoice_created", ДО оплаты)
- ✅ Формат данных соответствует API 1С
- ✅ Обрабатывается ответ 1С
- ✅ Флаг invoice_exported_to_1c обновляется

### 7.2. Экспорт заказов
- ✅ Экспорт заказов в 1С работает (при статусе "paid", ПОСЛЕ оплаты)
- ✅ Формат данных соответствует API 1С
- ✅ Обрабатывается ответ 1С
- ✅ Флаг order_exported_to_1c обновляется
